    ...
    <div className="bg-gray-100 min-h-screen py-6 lg:py-10">
      <div className="px-4 lg:px-10 xl:px-32 mb-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl lg:text-3xl font-bold text-gray-900">Top Salons</h1>
        ...
        {!isLoading && (isError || services.length === 0) && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500">We couldn't find any top salons near you right now.</p>
          </div>
        )}
