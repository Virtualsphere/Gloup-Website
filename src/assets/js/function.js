(function ($) {
  ...
  //       staggerAmount =
  //         parseFloat(element.getAttribute("data-stagger")) || staggerAmount;
  //     }

  //     if (element.getAttribute("data-translateX")) {
  //       translateXValue =
  //         parseFloat(element.getAttribute("data-translateX")) ||
  //         translateXValue;
  //     }

  //     if (element.getAttribute("data-translateY")) {
  //       translateYValue =
  //         parseFloat(element.getAttribute("data-translateY")) ||
  //         translateYValue;
  //     }

  //     if (element.getAttribute("data-on-scroll")) {
  //       scrollAnimation =
  //         parseInt(element.getAttribute("data-on-scroll")) || scrollAnimation;
  //     }

  //     if (element.getAttribute("data-delay")) {
  //       delayValue =
  //         parseFloat(element.getAttribute("data-delay")) || delayValue;
  //     }
