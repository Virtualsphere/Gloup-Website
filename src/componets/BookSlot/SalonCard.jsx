        ...
        <div className={`bg-white lg:bg-gray-100 pb-3 shadow-xl lg:shadow-none overflow-hidden border border-stone-100 ${rounded ? 'rounded-3xl' : ''}`}>
          ...
          <div className="flex gap-4 p-4 lg:px-0">
            ...
            <div className="flex-1 flex flex-col justify-center lg:justify-start gap-2">
              <h2
                className="text-stone-800 font-semibold leading-tight text-base lg:text-xl"
              >
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-stone-400 lg:text-stone-500 font-semibold text-sm lg:text-base">4.5</span>
                  <span className="text-stone-400 lg:text-stone-500 text-sm lg:text-base">(201)</span>
                </div>
                <div className="flex items-center gap-1 text-stone-600 text-sm">
                  <Users className="w-3 h-3 text-indigo-400" />
                  <span className="text-stone-500 text-sm lg:text-base">Unisex</span>
                </div>
              </div>
