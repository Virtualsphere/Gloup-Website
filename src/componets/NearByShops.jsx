...
function NearByShops({ nearBy = [], setIsHitFavourite }) {
  ...
  //         icon: "⚠️",
  //       });
  //       setIsHitFavourite(!isHitFavourite);
    ...
    <div>
      <div className="container-fluid mb-5 px-0 px-sm-4 px-md-0 px-lg-0 px-xl-0">
        <div class="container-fluid px-0 px-sm-4 px-md-5 px-lg-5 px-xl-5">
          <div className="row d-flex flex-wrap" style={{ rowGap: "25px" }}>
            {/* {nearBy?.length > 0 && ( */}
            <div className="mb-4">
            ...
            {/* )} */}
            {
              ...
              //     return (
              //       <div className="col-6 col-md-6 col-lg-3 d-flex" key={index}>
              //         <div
              ...
              //               swiperRef.current?.autoplay?.start()
              //             } // mobile
              //             onTouchEnd={() => swiperRef.current?.autoplay?.stop()} // mobile
              //           >
                      ...
                      <div className="service-content p-2 p-md-3 d-flex flex-column justify-content-between flex-grow-1">
                        ...
                        <div className="d-flex align-items-start" style={{marginTop:"5px"}}>
                          <MdLocationOn
                            ...
                            style={{ marginTop: "1.5px", marginLeft: "-3px",marginRight:"2px" }}
                          />
                          <span
            ...
            {/* No nearby services UI */}
            {nearBy?.length === 0 && (
              <div className="col-12 text-center mt-5">
                <div className="d-flex flex-column align-items-center">
                  <MdStoreMallDirectory size={60} color="#888" />
                  <h4 className="text-muted mt-3">No Salons found nearby</h4>
