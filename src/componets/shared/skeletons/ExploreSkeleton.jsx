...
// Exact SkeletonFavCard from ExploreSalons.jsx
...
const ExploreSkeleton = () => (
  <div className="page-favourites min-h-screen bg-gray-50 pb-20">
    ...
    {/* Mobile Top App Bar — exact match to ExploreSalons.jsx */}
    ...
    <div className="px-4 py-4 lg:py-8 lg:px-32 xl:px-32 mx-auto">
      {/* Header & Desktop Search — exact match */}
      <div className="mb-4 lg:mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="animate-pulse">
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-200 bg-gray-200 rounded w-48 h-8">‎</h2>
          <p className="text-sm text-gray-200 bg-gray-200 rounded w-64 h-4 mt-1">‎</p>
        </div>
        {/* Desktop search bar */}
        <div className="hidden lg:flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-2.5 w-[400px] animate-pulse">
          <div className="w-4 h-4 bg-gray-200 rounded-full flex-shrink-0" />
          <div className="flex-1 h-3 bg-gray-200 rounded" />
        </div>
      </div>

      {/* Skeleton cards — exact count and layout from ExploreSalons.jsx */}
