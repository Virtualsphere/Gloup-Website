      ...
      <div className="lg:bg-white lg:rounded-2xl lg:border lg:border-gray-200 lg:overflow-hidden">
        ...
        <div className="pt-4 lg:px-5 lg:pb-5">
          <p className="text-gray-700 text-sm lg:text-base font-normal mb-3">
            Bus Stop, Mudichar Rd, Parvathi Nagar, 600063
          </p>
          <button className="lg:flex items-center gap-2 text-sm lg:text-base font-semibold text-gray-900 hover:text-gray-600 transition-colors hidden">
        ...
        <button className="w-full py-3 border border-gray-200 rounded-xl flex items-center justify-center gap-2 text-sm font-medium text-gray-900 active:bg-gray-50 transition-colors lg:hidden">
