...
const ServiceSlider = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex lg:grid grid-cols-6 gap-4 lg:gap-5 px-3 lg:px-10 xl:px-32 py-2 lg:py-8 bg-white lg:bg-gray-100 overflow-x-auto lg:overflow-visible scrollbar-hide">
        {[...Array(6)].map((_, i) => (
  ...
  return (
    <div className="flex lg:grid grid-cols-6 gap-4 lg:gap-5 px-3 lg:px-10 xl:px-32 py-2 lg:py-8 bg-white lg:bg-gray-100 overflow-x-auto lg:overflow-visible scrollbar-hide pb-2">
